truncate table stores;
  ...
  insert into stores (STORE_ID,STORE_NAME,WEB_ADDRESS,PHYSICAL_ADDRESS,LATITUDE,LONGITUDE,LOGO,LOGO_MIME_TYPE) values (8,'Berlin',null,'Behrenstra�e 42 (Humboldt Carr�)
  ...
  insert into stores (STORE_ID,STORE_NAME,WEB_ADDRESS,PHYSICAL_ADDRESS,LATITUDE,LONGITUDE,LOGO,LOGO_MIME_TYPE) values (10,'Madrid',null,'C/ Jos� Echegaray 6B
    Las Rozas
  ...
  insert into stores (STORE_ID,STORE_NAME,WEB_ADDRESS,PHYSICAL_ADDRESS,LATITUDE,LONGITUDE,LOGO,LOGO_MIME_TYPE) values (18,'S�o Paulo',null,'Rua Dr. Jose Aureo Bustamante,
    455 - Vila Cordeiro,
    CEP 04710-090 S�o Paulo',-23.5475,-46.63611, EMPTY_BLOB(),null);
  ...
  insert into stores (STORE_ID,STORE_NAME,WEB_ADDRESS,PHYSICAL_ADDRESS,LATITUDE,LONGITUDE,LOGO,LOGO_MIME_TYPE) values (20,'Mexico City',null,'Montes Urales # 470 P3
    ...
    Delegaci�n Miguel Hidalgo - C.P. 11000',19.428489,-99.205745, EMPTY_BLOB(),null);
